        ...
        <div class="mui-card" v-for="(v,i) in initData" :key="v.e_id">
            ...
            <div class="mui-card-content">
                <ul class="mui-table-view mui-grid-view">
                    <li class="mui-table-view-cell mui-media mui-col-xs-4" v-for="item in v.picUrl" :key="item.id">
                        <img v-preview="item.url" :src="item.url" />
                    </li>
                </ul>
            </div>
            <div class="mui-card-footer" v-html='v.content'></div>
        </div>
    </div>
</template>
<script>
...
export default {
    ...
    methods: {
        getData() {
            this.$http.jsonp("http://v.juhe.cn/todayOnhistory/queryDetail.php", {
                params: {
